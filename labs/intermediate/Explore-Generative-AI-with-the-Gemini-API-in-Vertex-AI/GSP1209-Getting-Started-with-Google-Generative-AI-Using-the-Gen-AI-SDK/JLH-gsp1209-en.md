...
For more information about all AI models and APIs on Vertex AI, refer to [Google Models](https://cloud.google.com/vertex-ai/generative-ai/docs/learn/models#gemini-models) and [Model Garden](https://cloud.google.com/vertex-ai/docs/model-garden/explore-models).
...
2. Delete any manually created Cloud Storage buckets
...
**Original Lab Link**: https://www.skills.google/course_templates/959/labs/592557
**GSP Number**: GSP1209
**Completion Date**: 2025-11-05
**File Location**: intermediate/Explore-Generative-AI-with-the-Gemini-API-in-Vertex-AI/GSP1209-Getting-Started-with-Google-Generative-AI-Using-the-Gen-AI-SDK/
